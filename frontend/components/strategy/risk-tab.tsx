      ...
      <CardContent className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-muted-foreground">
                {risk.stop_loss.mode === "manual_pct"
                  ? "Stop at: entry price x (1 - percentage)."
                  : "Stop at: entry price - ATR(14) x multiplier."}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-muted-foreground">
                {risk.take_profit.mode === "manual_pct"
                  ? "Target at: entry price x (1 + percentage)."
                  : "Target at: entry + stop_distance x R:R ratio."}
              </p>
            </div>
        ...
        <div className="grid gap-4 xl:grid-cols-2">
          <div className="space-y-1">
            ...
            />
            <p className="px-3 text-[11px] text-muted-foreground">Wait N bars after closing before re-entering.</p>
          </div>
          ...
          <div className="space-y-3 rounded-xl border p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Force exit after holding for N bars.</p>
              </div>
              <Switch
