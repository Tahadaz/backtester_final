...
export const SignalEvidenceStitchedMetricsSchema = z.object({
  ...
  profit_factor_net: z.number().nullable().optional(),
  avg_win_net: z.number().nullable().optional(),
  avg_loss_net: z.number().nullable().optional(),
  payoff_ratio_net: z.number().nullable().optional(),
  median_return_net: z.number().nullable().optional(),
  p05_return_net: z.number().nullable().optional(),
  p95_return_net: z.number().nullable().optional(),
  sortino: z.number().nullable().optional(),
  sharpe_path: z.number().nullable().optional(),
  calmar: z.number().nullable().optional(),
  annualized_volatility: z.number().nullable().optional(),
  downside_volatility: z.number().nullable().optional(),
  beta: z.number().nullable().optional(),
  alpha_annualized: z.number().nullable().optional(),
  alpha_r2: z.number().nullable().optional(),
  alpha_n_obs: z.number().nullable().optional(),
  alpha_reason: z.string().nullable().optional(),
  benchmark_symbol: z.string().nullable().optional(),
  sample_start: z.string().nullable().optional(),
  sample_end: z.string().nullable().optional(),
  sample_days: z.number().nullable().optional(),
  min_sample_pass: z.boolean().nullable().optional(),
...
export const SignalEvidenceStitchedOosBacktestSchema = z.object({
  ...
  benchmark_returns: z.array(z.number().nullable()).optional(),
  benchmark_symbol: z.string().nullable().optional(),
  benchmark_status: z.string().nullable().optional(),
