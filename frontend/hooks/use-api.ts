...
import type {
  ...
  SupportResistanceVariantsResponse,
...
import {
  ...
  fetchSupportResistanceMethodDetail,
  fetchSupportResistanceVariants,
  fetchSupportResistanceVariantDetail,
  fetchSupportResistanceVariantBacktest,
  fetchLevels,
  fetchMasiTickers,
...
export function useFamilyEnsemble(
  family: string | null,
  symbol: string | null,
  horizon: string | null,
  costBps?: number,
...
export function useSupportResistanceMethodDetail(
  symbol: string | null,
  horizon: string | null,
...
export function useSupportResistanceVariants(
  symbol: string | null,
  horizon: string | null,
  costBps?: number,
  cooldownBars?: number,
...
export function useSupportResistanceVariantBacktest(
  variantId: string | null,
  symbol: string | null,
  horizon: string | null,
  costBps?: number,
...
export function useSupportResistanceVariantDetail(
  variantId: string | null,
  symbol: string | null,
  horizon: string | null,
  costBps?: number,
  ...
  return useSWR<StrategyBacktestRun>(
    ...
    () => fetchStrategyBacktestRun(runId!),
    {
      ...
      refreshInterval: (data) => {
        ...
        const status = data?.status
        if (status === "queued" || status === "running" || status === "cancel_requested") return refreshInterval
        return 0
      },
    }
  )
...
export function useStrategyBacktestWindowDetail(
  runId: string | null,
  symbol: string | null,
  windowIndex: number | null,
) {
  return useSWR<StrategyBacktestWindowDetail>(
    runId && symbol && windowIndex != null
      ? `/backtest/strategy-runs/${runId}/stocks/${symbol}/windows/${windowIndex}`
      : null,
    () => fetchStrategyBacktestWindowDetail(runId!, symbol!, windowIndex!),
    { revalidateOnFocus: false },
  )
}
