...
_STATIC_FALLBACK: list[MacroSeriesSpec] = [
    ...
    MacroSeriesSpec(
        symbol="^NDX",
        canonical_id="NDX",
        description="Nasdaq 100 - US growth equity risk",
        timezone="America/New_York",
        close_time_utc="21:00",
        channel_tags=["all"],
    ),
    MacroSeriesSpec(
        symbol="^N225",
        canonical_id="N225",
        description="Nikkei 225 - Asia equity risk",
        timezone="Asia/Tokyo",
    ...
    MacroSeriesSpec(
        symbol="^FCHI",
        canonical_id="CAC",
        description="CAC 40 - Europe equity risk",
    ...
    MacroSeriesSpec(
        symbol="^FTSE",
        canonical_id="FTSE",
        description="FTSE 100 - Europe equity risk",
