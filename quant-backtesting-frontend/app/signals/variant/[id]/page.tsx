...
export default function VariantDetailPage() {
  ...
  const { data, isLoading, error } = useVariantDetail(variantId, symbol, horizon, costBps, cooldownBars)
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-5">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <SignalBadge value={data.signal} label={data.signal_label} size="sm" />
      ...
      {/* Tab content */}
      {tab === "comparaison" && <ComparisonTab data={data} currentId={variantId} symbol={symbol} horizon={horizon} costBps={costBps} cooldownBars={cooldownBars} />}
      ...
      {isExpanded && (
        <tr>
          <td colSpan={11} className="p-0">
            <VariantDetailPanel variantId={v.variant_id} symbol={symbol} horizon={horizon} costBps={costBps} cooldownBars={cooldownBars} />
          </td>
        </tr>
      )}
    </>
