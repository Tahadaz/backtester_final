...
> = {
  sma: {
    window: {
      short: { scan_min: 5, scan_max: 40, scan_step: 1 },
      medium: { scan_min: 20, scan_max: 100, scan_step: 2 },
      long: { scan_min: 50, scan_max: 250, scan_step: 5 },
    },
  },
  rsi: {
    period: {
      short: { scan_min: 5, scan_max: 14, scan_step: 1 },
      medium: { scan_min: 10, scan_max: 25, scan_step: 1 },
      long: { scan_min: 14, scan_max: 40, scan_step: 1 },
    },
  },
  macd: {
    fast: {
      short: { scan_min: 5, scan_max: 12, scan_step: 1 },
      medium: { scan_min: 8, scan_max: 18, scan_step: 1 },
      long: { scan_min: 12, scan_max: 26, scan_step: 1 },
    },
    slow: {
      short: { scan_min: 12, scan_max: 26, scan_step: 1 },
      medium: { scan_min: 20, scan_max: 40, scan_step: 2 },
      long: { scan_min: 26, scan_max: 52, scan_step: 2 },
    },
    signal: {
...
export function defaultIndicatorRowConfig(
  ...
  const params: Record<string, WFOParam<number>> =
    familyId === "sma"
      ? { window: manualParam(20) }
      : familyId === "rsi"
        ? { period: manualParam(14) }
        : familyId === "macd"
