...
import { AlertCircle, Activity, BarChart3, TrendingUp } from "lucide-react"
...
import type { IndicatorExplorerState, IndicatorFamilyKey } from "./indicator-explorer"
                    ...
                    return (
                      <div key={param.key} className="space-y-2">
                        ...
                        <Slider
                          ...
                          step={param.step}
                          value={[value]}
                          onValueChange={(values) => onParamChange(family.key, param.key, values[0] ?? value)}
                        />
                      </div>
                    )
                  })}
