...
def test_user_corrected_closure_dates_are_present() -> None:
    expected = {
        ...
        date(2023, 9, 28): "Aïd Al-Mawlid Annabawi",
        date(2023, 9, 29): "Aïd Al-Mawlid Annabawi",
        date(2022, 5, 2): "Eid al-Fitr",
        date(2022, 5, 3): "Eid al-Fitr",
        date(2021, 7, 21): "Eid al-Adha",
        date(2021, 7, 22): "Eid al-Adha",
        date(2021, 10, 19): "Aïd Al-Mawlid Annabawi",
        date(2021, 10, 20): "Aïd Al-Mawlid Annabawi",
    }
