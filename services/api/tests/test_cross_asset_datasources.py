...
from services.api.app.services.cross_asset.datasources import FRED_RATE_SERIES, FX_PAIRS, assemble_fx_panel
...
def _rate_loader(series_id, key, start, end):
    ...
    offset = list(FRED_RATE_SERIES.values()).index(series_id) / 1000
