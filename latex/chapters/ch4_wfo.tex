...
%% ============================================================
\chapter{Moteur WFO des signaux}
\label{ch:wfo}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{generated/ch4_wfo_pipeline.png}
\caption{Pipeline WFO des signaux~: optimisation in-sample, application out-of-sample,
agrégation des fenêtres et production d'un score courant. Sources~: Pardo~\cite{pardo2008}
et implémentation locale du moteur WFO.}
\label{fig:ch4_wfo_pipeline}
\end{figure}
...
(4 catégories × 3 horizons) sur l'ensemble de l'univers MASI suivi prend plusieurs heures.
