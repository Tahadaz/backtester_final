...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{generated/ch2_taxonomie.png}
\caption{Taxonomie des vingt familles d'indicateurs utilisées par le Signal Engine.
Source~: documentation locale du moteur de signaux~\cite{repo_signal_docs}.}
\label{fig:ch2_fig1_taxonomie}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{generated/ch2_sma_iam.png}
\caption{Exemple de moyennes mobiles sur l'action IAM~: clôture, SMA20, SMA50 et EMA200.
Source~: historique local IAM, calculs de l'auteur.}
\label{fig:ch2_fig2_sma}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{generated/ch2_rsi_atw.png}
\caption{Exemple de RSI 14 périodes sur l'historique local disponible~: zones de
surachat ($>70$) et de survente ($<30$). Source~: fichier de données local,
calculs de l'auteur.}
\label{fig:ch2_fig3_rsi}
\end{figure}
...
Pour un univers MASI large, la plateforme peut tester 20 familles × 30 valeurs de
paramètres par horizon × plusieurs dizaines de titres, soit des dizaines de milliers
de configurations. Sous un seuil de significativité $\alpha = 5\,\%$,
